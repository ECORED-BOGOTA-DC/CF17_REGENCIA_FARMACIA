  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="flip-up")
      .titulo-principal__numero
        span 2
      h1 Productos y características
    .cont_2_1
      .row
        .col-lg-6.mb-4.mb-lg-0(style="place-self:center;")
          p(data-aos="fade-up") Se considera que el producto es una suma de características y atributos que son palpables (forma, tamaño, color, entre otros) e intangibles (marca, imagen de empresa, servicio, entre otros), las cuales el comprador acepta, en principio, como algo que va a satisfacer sus necesidades.
          p.mt-4(data-aos="fade-up") Uno de los objetivos principales de los inventarios es garantizar que estos productos roten, no se deterioren y generen beneficios a la empresa y sus clientes.
          p.mt-4(data-aos="fade-up") En los establecimientos y servicios farmacéuticos se encuentran productos característicos y funciones diferentes con respecto a su orientación, función, presentación, información técnica, requerimientos para su almacenamiento y otros aspectos importantes.
        .col-lg-6(style="place-self:center;")
          figure
            img.m-auto(src="@/assets/curso/tema2/2.svg" data-aos="fade-left" alt="Imagen decorativa" style="max-width:350px;")
      .row.mt-5.col-lg-10.m-auto
        .col-lg-6.mb-4.mb-lg-0(style="place-self:center;")
          figure.d-none.d-lg-block
            img.m-auto(src="@/assets/curso/tema2/3.svg" data-aos="fade-right" alt="Imagen decorativa" style="max-width:350px;")
        .col-lg-6(style="place-self:center;")
          .p-4(data-aos="fade-left" style="background-color:#F6F6F6;border-radius:0px 40px 40px 0px;")
            p  Entre estos están:
    ...
    .row
      ...
      .col-lg-8(style="place-self:center;")
        figure
          img.m-auto(src="@/assets/curso/tema2/4.png" data-aos="fade-left" alt="Imagen decorativa" style="max-width:550px;")
    ...
    .row.mt-5
      ...
      .col-lg-5.mb-4.mb-lg-0(style="place-self:center;")
        figure
          img.m-auto(src="@/assets/curso/tema2/5.svg" data-aos="fade-right" alt="Imagen decorativa" style="max-width:350px;")
      .col-lg-6(style="place-self:center;")
        ...
        ul.lista-ul.mt-3.mb-0
          ...
          li(data-aos="fade-up")
            i.fas.fa-atom(style="color:#FF9D00;")
            | Biológico, etc.
    p.mt-0.mt-lg-4(data-aos="fade-right") A continuación, se presenta un ejemplo de las características de la estructura de una ficha técnica de un producto farmacéutico, donde se evidencia lo completo que es el documento, debido a que aplica tanto para establecimientos farmacéuticos comerciales como las farmacias/droguerías, droguerías y depósitos, como para los servicios farmacéuticos, porque la información abarca temas comerciales, de almacenamiento, conservación y clínicos.
    .col-lg-8.m-auto.mt-5
      figure
        img.m-auto(src="@/assets/curso/tema2/6.svg" data-aos="zoom-in-up" alt="Imagen con una ficha técnica de un producto farmacéutico, la cual contiene la siguiente información: 1. NOMBRE DEL MEDICAMENTO. 2. COMPOSICIÓN CUALITATIVA Y CUANTITATIVA. 3. FORMA FARMACÉUTICA. 4. DATOS CLÍNICOS (indicaciones, posología, contraindicaciones, advertencias, interacciones, fertilidad, embarazo y lactancia, efectos sobre la capacidad para conducir y utilizar máquinas, reacciones adversas, sobredosis). 5. PROPIEDADES FARMACOLÓGICAS 5.1 Propiedades farmacodinámicas 5.2 Propiedades farmacocinéticas 5.3 Datos preclínicos sobre seguridad 6. DATOS FARMACÉUTICOS 6.1 Lista de excipientes 6.2 Incompatibilidades 6.3 Periodo de validez 6.4 Precauciones especiales de conservación 6.5 Naturaleza y contenido del envase 6.6 Precauciones especiales de eliminación. 7. TITULAR DE LA AUTORIZACIÓN DE COMERCIALIZACIÓN 8. NÚMERO(S) DE AUTORIZACIÓN DE COMERCIALIZACIÓN 9. FECHA DE LA PRIMERA AUTORIZACIÓN/ RENOVACIÓN DE LA AUTORIZACIÓN 10. FECHA DE LA REVISIÓN DEL TEXTO" style="max-width:950px;")
    .row.mt-5.p-3(style="background-color:#E6F7FE;")
      .col-lg-11.row.m-auto
        .col-lg-4.col-md-5.mb-4.mb-md-0(style="place-self:center;")
          figure
            img.m-auto(src="@/assets/curso/tema2/7.svg" data-aos="fade-right" alt="Imagen decorativa" style="max-width:350px;")
        .col-lg-8.col-md-7(style="place-self:center;")
          ...
          a.anexo.mt-4.bg-white(:href="obtenerLink('downloads/Anexo2_CF017_ejemplo_ficha_tecnica.pdf')" target="_blank")
            .anexo__icono
              img.m-auto(src="@/assets/template/icono-pdf.svg" style="max-width:350px;")
            .anexo__texto
    ...
    .col-lg-8.m-auto.mt-5
      figure
        img.m-auto(src="@/assets/curso/tema2/8.svg" data-aos="zoom-in-up" alt="Imagen decorativa" style="max-width:950px;")
    .row.mt-5.p-3(style="background-color:#E6F7FE;")
      .col-lg-11.row.m-auto
        .col-lg-4.col-md-5.mb-4.mb-md-0(style="place-self:center;")
          figure
    ...
    p(data-aos="fade-right") Se debe recordar que la ficha técnica es un documento de gran utilidad para todos los profesionales que hacen parte del sector farmacéutico y en general del sector salud. También es una herramienta para la autoridad sanitaria, debido a que abarca información legal y técnica de los productos farmacéuticos.
    p.mt-4(data-aos="fade-right") Tiene, entre otras, las siguientes aplicaciones:
    .row.mt-5
      .col-lg-3.mb-4.mb-lg-0(style="place-self:end;")
        figure.figure_img1(style="position:relative;" alt="Imagen decorativa")
          img.m-auto(src="@/assets/curso/tema2/9.svg" data-aos="zoom-in-up" style="max-width:250px;")
      .col-lg-9.row(data-aos="fade-left")
