  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .cont_2_1
      ...
      .row.mt-5.col-lg-10.m-auto
        .col-lg-6.mb-4.mb-lg-0(style="place-self:center;")
          figure
            img(src="@/assets/curso/tema2/3.svg" data-aos="fade-right" alt="Imagen decorativa")
        .col-lg-6(style="place-self:center;")
    ...
    .row
      ...
      .col-lg-8(style="place-self:center;")
        figure
          img(src="@/assets/curso/tema2/4.png" data-aos="fade-left" alt="Imagen decorativa")
    ...
    .row.mt-5
      ...
      .col-lg-5.mb-4.mb-lg-0(style="place-self:center;")
        figure
          img(src="@/assets/curso/tema2/5.svg" data-aos="fade-right" alt="Imagen decorativa")
      .col-lg-6(style="place-self:center;")
    ...
    .col-lg-8.m-auto.mt-5
      figure
        img(src="@/assets/curso/tema2/6.svg" data-aos="zoom-in-up" alt="Imagen con una ficha técnica de un producto farmacéutico, la cual contiene la siguiente información: 1. NOMBRE DEL MEDICAMENTO. 2. COMPOSICIÓN CUALITATIVA Y CUANTITATIVA. 3. FORMA FARMACÉUTICA. 4. DATOS CLÍNICOS (indicaciones, posología, contraindicaciones, advertencias, interacciones, fertilidad, embarazo y lactancia, efectos sobre la capacidad para conducir y utilizar máquinas, reacciones adversas, sobredosis). 5. PROPIEDADES FARMACOLÓGICAS 5.1 Propiedades farmacodinámicas 5.2 Propiedades farmacocinéticas 5.3 Datos preclínicos sobre seguridad 6. DATOS FARMACÉUTICOS 6.1 Lista de excipientes 6.2 Incompatibilidades 6.3 Periodo de validez 6.4 Precauciones especiales de conservación 6.5 Naturaleza y contenido del envase 6.6 Precauciones especiales de eliminación. 7. TITULAR DE LA AUTORIZACIÓN DE COMERCIALIZACIÓN 8. NÚMERO(S) DE AUTORIZACIÓN DE COMERCIALIZACIÓN 9. FECHA DE LA PRIMERA AUTORIZACIÓN/ RENOVACIÓN DE LA AUTORIZACIÓN 10. FECHA DE LA REVISIÓN DEL TEXTO")
    
    .row.mt-5.p-3(style="background-color:#E6F7FE;")
      .col-lg-11.row.m-auto
        .col-lg-4.col-md-5.mb-4.mb-md-0(style="place-self:center;")
          figure
            img(src="@/assets/curso/tema2/7.svg" data-aos="fade-right" alt="Imagen decorativa")
    ...
    .col-lg-8.m-auto.mt-5
      figure
        img(src="@/assets/curso/tema2/8.svg" data-aos="zoom-in-up" alt="Imagen decorativa")
