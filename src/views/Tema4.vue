...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mt-5.cont_4_2.m-auto.pt-5
      .col-lg.mb-4.mb-lg-0
        figure
          img(src="@/assets/curso/tema4/6.svg" data-aos="fade-right")
      .col-lg
        figure
          img(src="@/assets/curso/tema4/7.svg" data-aos="fade-left")
    ...
    .row.mt-5
      ...
      .col-lg-4(style="place-self:end;")
        figure
          img(src="@/assets/curso/tema4/10.svg" data-aos="fade-left")
