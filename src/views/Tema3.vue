  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row
      ...
      .col-lg-8(style="place-self:center;")
        ...
        p.mt-3(data-aos="fade-up") La rastreabilidad o trazabilidad, es la capacidad de rastrear el historial, la aplicación o la ubicación de una entidad (actividad, proceso, producto, organización, individuo) a través de la información almacenada en un registro.
        .cajon.color-secundario.p-4.mt-4(style="background-color:#E4DDFA;")
          p.mb-0(data-aos="fade-up") “Le corresponde al INVIMA garantizar la identificación de los medicamentos en cualquier parte de la cadena de distribución, desde la producción hasta el consumidor final, mediante una tecnología de señalización, con el objetivo de evitar la falsificación, adulteración, vencimiento y contrabando.
    
    p.mt-5(data-aos="fade-up") Colombia viene trabajando en un piloto basado en la aplicación de estándares internacionales que garanticen la seguridad y calidad de los medicamentos y dispositivos médicos en todos los procesos del ciclo de gestión de cualquier servicio farmacéutico, distribuidor mayorista y sus respectivas droguerías.
    ...
    .row.mt-5.col-lg-10.m-auto
      .col-lg-6.mb-4.mb-lg-0(style="place-self:center;")
        figure
          img(src="@/assets/curso/tema3/12.png" data-aos="fade-right")
    ...
    .row.mt-5.p-3(style="background-color:#E6F7FE;")
      .col-lg-11.row.m-auto
        .col-lg-4.col-md-5.mb-4.mb-md-0(style="place-self:center;")
          figure
            img(src="@/assets/curso/tema3/13.svg" data-aos="fade-right")
    ...
    .row.m-auto.mt-5
      .col-lg-8.mb-4.mb-lg-0(style="place-self:center;")
        figure
          img(src="@/assets/curso/tema3/16.png" data-aos="fade-right")
      .col-lg-4(style="place-self:center;")
      ...
      .bloque-texto-a.color-secundario.p-4.p-md-5
        .row.m-0.align-items-center.justify-content-between
          .col-lg-4.mb-4.mb-lg-0
            figure.text-center
              img(src="@/assets/curso/tema3/18.svg" data-aos="fade-right" style="max-width:150px;display:inline;")
          .col-lg-8
