...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-center
      .col-lg-4.mb-4.mb-lg-0.cont_1_1(style="place-self:center;")(data-aos="fade-right")
        figure
    ...
    .row.cont_1_2.mt-5
      .col-lg-7.mb-4.mb-lg-0(style="place-self:center;")(data-aos="fade-right")
        figure
          img.m-auto(src="@/assets/curso/tema1/5.png" alt="Imagen decorativa" style="max-width:400px;")
      .col-lg-5(style="place-self:center;")(data-aos="fade-left")
        .p-4.cont_responsive2( style="background-color:#F6F6F6;width:150%;left:-70%;right: 0;border-radius:0px 40px 40px 0px;position:relative;z-index:2;")
    ...
    .col-lg-8.mt-5.m-auto
      .titulo-sexto.color-acento-botones.mt-5
        p.mb-0 #[b Figura 1]. Toma inventario físico
      figure.mt-5
        img.m-auto(src="@/assets/curso/tema1/6.png" data-aos="zoom-in-up" alt="Imagen con una persona haciendo un inventario en una bodega" style="max-width:550px;")
    ...
    p(data-aos="fade-right") Esta gestión se realiza mediante la ejecución de diferentes tipos de inventario, dependiendo de la cantidad de mercancías manipuladas, de la siguiente manera:
    .tarjeta.tarjeta--azul.p-4.mt-5(style="background-color:#DEE4F0;")(data-aos="fade-left")
      SlyderA(tipo="b")
    ...
    p(data-aos="fade-right") Las tres características que identifican a los inventarios, son:
    .row.mt-4(data-aos="fade-left")
      .col-12
        ImagenInfografica.color-acento-botones.infografia1
          template(v-slot:imagen)
            figure
              img.m-auto(src='@/assets/curso/tema1/16.svg' alt="Imagen decorativa")
